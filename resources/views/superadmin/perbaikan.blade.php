        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content" style="min-height: 612px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button" class="btn btn-sm btn-success"
                                                                    data-toggle="modal"
                                                                    data-target="#keteranganModal{{ $perbaikan->id_logkul }}"
                                                                    title="Done">
                                                                    Done
                                                                </button>
                ...
                @foreach ($data as $perbaikan)
                    <div class="modal fade" id="keteranganModal{{ $perbaikan->id_logkul }}" tabindex="-1"
                        role="dialog" aria-labelledby="keteranganModalLabel{{ $perbaikan->id_logkul }}"
                        aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="keteranganModalLabel{{ $perbaikan->id_logkul }}">
                                        Keterangan Perbaikan</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <!-- Form untuk menulis keterangan perbaikan -->
                                    <form action="{{ route('perbaikan.store', $perbaikan->id_logkul) }}"
                                        method="post">
                                        @csrf
                                        <input type="hidden" name="logkuliah_id"
                                            value="{{ $perbaikan->id_logkul }}">
                ...
                @foreach ($data as $perbaikan)
                    <!-- Modal -->
                    <div class="modal fade" id="viewModal{{ $perbaikan->id_logkul }}" tabindex="-1" role="dialog"
                        aria-labelledby="viewModalLabel{{ $perbaikan->id_logkul }}" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewModalLabel{{ $perbaikan->id_logkul }}">View
                                        Details
                                    </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
