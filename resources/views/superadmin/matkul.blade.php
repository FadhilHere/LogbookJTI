                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('matkul.update', $matakuliah->id_matakuliah) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kelasEdit{{ $matakuliah->id_matakuliah }}" name="kelas">
                                        @foreach($kelas as $kelasItem)
                                            <option value="{{ $kelasItem->id_kelas }}" {{ $matakuliah->id_kelas == $kelasItem->id_kelas ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="editHari{{ $matakuliah->id_matakuliah }}" name="hari" required>
                                        ...
                                        <option value="Minggu" {{ $matakuliah->hari == 'Minggu' ? 'selected' : '' }}>Minggu</option>
                                    </select>
                                </div>
			                                ...
			                                <div class="form-group">
						                                    <label for="id_lab">Ruang Lab</label>
									                                        <select class="form-control" id="id_lab" name="id_lab" required>
												                                            @foreach($datalab as $lab)
															                                            <option value="{{ $lab->id_lab }}" {{ $matakuliah->id_lab == $lab->id_lab ? 'selected' : '' }}>
																		                                            {{ $lab->ruang_lab }}
																					                                        </option>
																							                                            @endforeach
																									                                        </select>
                                ...
                                <div class="form-group">
                                    <label for="editTanggalSelesai{{ $matakuliah->id_matakuliah }}">Tanggal
                                            Selesai</label>
	                                    <input type="date" class="form-control"
	                                        id="editTanggalSelesai{{ $matakuliah->id_matakuliah }}" name="tanggalSelesai"
	                                            value="{{ $matakuliah->tanggalSelesai }}">
	                                    </div>
...
<script>
        ...
        function updateSemester() {
            ...
            var semester = (new Date(tanggalSelesai + 'T00:00:00') <= new Date((new Date()).getFullYear() + '-02-24T00:00:00')) ? 'ganjil' : 'genap';
