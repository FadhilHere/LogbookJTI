        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="#" class="menu-toggle nav-link has-dropdown toggled"><svg xmlns="http://www.w3.org/2000/svg"
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link " href="{{ route('kegiatan.index') }}">Log
                    Kegiatan</a></li>
                  ...
                  <div class="card-body">
                    <div class="float-left">
                      <div class="dropdown" style="margin-bottom: 15px;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="exportDropdown">
                          <a class="dropdown-item" href="{{ route('kuliah.export.excelKuliahMingguan') }}">Excel
                            Mingguan</a>
                          <a class="dropdown-item" href="{{ route('kuliah.export.excelKuliahBulanan') }}">Excel
                            Bulanan</a>
                        </div>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-md-6 d-flex align-items-end ">
                        <div class="dropdown">
                          <button class="btn btn-info dropdown-toggle" type="button" id="labFilterDropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Filter Lab
                          </button>
                          <div class="dropdown-menu" aria-labelledby="labFilterDropdown">
                            <a class="dropdown-item lab-filter-dropdown-item" href="#" data-value="semua_lab">Semua
                              Lab</a>
                            @foreach($listRuangLab as $ruangLab)
                            <a class="dropdown-item lab-filter-dropdown-item" href="#" data-value="{{ $ruangLab }}">{{
                              $ruangLab }}</a>
                            @endforeach
                          </div>
                        </div>
                        ...
                        <form id="filterForm" class="ml-2">
                          <input type="hidden" id="labFilter" name="labFilter" value="{{ $labFilter ?? '' }}">
...
<th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
				...
				<td>{{ $logKeg->tanggal }}</td>
                              ...
                              <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                  action="{{ route('kegiatan.destroy', $logKeg->id_logke) }}" method="post">
                                  ...
                                  <div class="btn-group" role="group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mr-1" data-toggle="modal"
                                      data-target="#viewModal{{ $logKeg->id_logke }}">
            ...
            <div class="card-body">
              <div class="float-left">
                <div class="dropdown" style="margin-bottom: 15px;">
                  ...
                  <div class="dropdown-menu" aria-labelledby="exportDropdown">
                    <a class="dropdown-item" href="{{ route('kuliah.export.excelKegiatanPICMingguan') }}">Excel
                      Mingguan</a>
                    <a class="dropdown-item" href="{{ route('kuliah.export.excelKegiatanPICBulanan') }}">Excel
                      Bulanan</a>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <table class="table table-striped dataTable no-footer" id="table-2" role="grid"
                    ...
                    <thead>
                      <tr role="row">
                        <th class="text-center sorting_asc" tabindex="0" aria-controls="table-2" rowspan="1" colspan="1"
                          aria-sort="ascending" aria-label="#: activate to sort column descending"
                          style="width: 35.9px;">#</th>
                        <th class="sorting" tabindex="1" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Nama: activate to sort column ascending" style="width: 182.087px;">Nama</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Lab: activate to sort column ascending" style="width: 182.087px;">Lab</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="NIM: activate to sort column ascending" style="width: 182.087px;">NIM
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="No HP: activate to sort column ascending" style="width: 182.087px;">No HP
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Email: activate to sort column ascending" style="width: 182.087px;">Email
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Kegiatan: activate to sort column ascending" style="width: 182.087px;">
                          Kegiatan</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Tanggal Mulai: activate to sort column ascending" style="width: 182.087px;">
                          Tanggal Mulai</th>
			<th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Tanggal Mulai: activate to sort column ascending" style="width: 182.087px;">
                          Tanggal Selesai</th>
			  <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Jam Masuk: activate to sort column ascending" style="width: 182.087px;">Jam
                          Masuk</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Jam Masuk: activate to sort column ascending" style="width: 182.087px;">Jam
                          Keluar</th>
                        <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"
                          aria-label="Total Hari: activate to sort column ascending" style="width: 182.087px;">
                          Total Hari</th>
                    ...
                    <tbody>
                      @forelse ($dataPIC as $index => $logKeg)
                      <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $logKeg->nama }}</td>
                        <td>{{ $logKeg->ruang_lab }}</td>
                        ...
                        <td>{{ $logKeg->nohp }}</td>
                        <td>{{ $logKeg->email }}</td>
                        <td>{{ $logKeg->kegiatan }}</td>
			<td>{{ $logKeg->tanggalMulai }}</td>
                        <td>{{ $logKeg->tanggalSelesai }}</td>
                        <td>{{ $logKeg->jamMasuk }}</td>
                        <td>{{ $logKeg->jamKeluar }}</td>
                        <td>{{ $logKeg->totalHari }} hari</td>	
                        ...
                        <td class="text-center">
                          <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                            ...
                            <div class="btn-group" role="group">
                              ...
                              <button type="button" class="btn btn-sm btn-info mr-1" data-toggle="modal"
                                data-target="#viewModalPIC{{ $logKeg->id_logke }}">
                                <i class="fas fa-eye"></i>
                              </button>
                              <button type="submit" class="btn btn-sm btn-danger mr-1">
                                <i class="fas fa-trash"></i>
                      ...
                      <tr>
                        <td colspan="16" class="text-center">
                          <div class="alert alert-danger">
                            Data log PIC kegiatan belum Tersedia.
                          </div>
                        </td>
                      </tr>
                      @endforelse
        ...
        <!-- Modal View -->
        @foreach ($dataPIC as $logKeg)
        <!-- Modal -->
        <div class="modal fade" id="viewModalPIC{{ $logKeg->id_logke }}" tabindex="-1" role="dialog"
          aria-labelledby="viewModalLabelPIC{{ $logKeg->id_logke }}" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="viewModalLabelPIC{{ $logKeg->id_logke }}">View Details</h5>
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-4">
                    <p><strong>Lab:</strong> {{ $logKeg->ruang_lab }}</p>
                    <p><strong>Nama:</strong> {{ $logKeg->nama }}</p>
                    <p><strong>NIM:</strong> {{ $logKeg->nim }}</p>
                    <p><strong>No HP:</strong> {{ $logKeg->nohp }}</p>
                  </div>
                  <div class="col-md-4">
                    <p><strong>Email:</strong> {{ $logKeg->email }}</p>
                    <p><strong>Kegiatan:</strong> {{ $logKeg->kegiatan }}</p>
                    <p><strong>Tanggal Mulai:</strong> {{ $logKeg->tanggalMulai }}</p>
                    <p><strong>Tanggal Selesai:</strong> {{ $logKeg->tanggalSelesai }}</p>
                  </div>
                  <div class="col-md-4">
                    <p><strong>Jam Masuk:</strong> {{ $logKeg->jamMasuk }}</p>
                    <p><strong>Jam Keluar:</strong> {{ $logKeg->jamKeluar }}</p>
                    <p><strong>Peserta:</strong> {{ $logKeg->peserta }}</p>
        ...
        <!-- Modal -->
        <div class="modal fade" id="viewModal{{ $logKeg->id_logke }}" tabindex="-1" role="dialog"
          aria-labelledby="viewModalLabel{{ $logKeg->id_logke }}" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="viewModalLabel{{ $logKeg->id_logke }}">View Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
