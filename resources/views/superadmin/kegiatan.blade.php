                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($logKeg->monitor == 'bagus')
                                                                        <span
                                                                            class="badge badge-success">{{ $logKeg->monitor }}</span>
                                                                    @elseif($logKeg->monitor == 'rusak')
                                                                        <span
                                                                            class="badge badge-danger">{{ $logKeg->monitor }}</span>
                                                                    @else
                                                                        {{ $logKeg->monitor }}
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if ($logKeg->keyboard == 'bagus')
                                                                        <span
                                                                            class="badge badge-success">{{ $logKeg->keyboard }}</span>
                                                                    @elseif($logKeg->keyboard == 'rusak')
                                                                        <span
                                                                            class="badge badge-danger">{{ $logKeg->keyboard }}</span>
                                                                    @else
                                                                        {{ $logKeg->keyboard }}
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if ($logKeg->mouse == 'bagus')
                                                                        <span
                                                                            class="badge badge-success">{{ $logKeg->mouse }}</span>
                                                                    @elseif($logKeg->mouse == 'rusak')
                                                                        <span
                                                                            class="badge badge-danger">{{ $logKeg->mouse }}</span>
                                                                    @else
                                                                        {{ $logKeg->mouse }}
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @if ($logKeg->jaringan == 'bagus')
                                                                        <span
                                                                            class="badge badge-success">{{ $logKeg->jaringan }}</span>
                                                                    @elseif($logKeg->jaringan == 'rusak')
                                                                        <span
                                                                            class="badge badge-danger">{{ $logKeg->jaringan }}</span>
                                                                    @else
                                                                        {{ $logKeg->jaringan }}
                                                                    @endif
                                                                </td>
                                                                <td class="text-center">
                                                                    <form
                                                                        ...
                                                                        action="{{ route('kegiatan.destroy', $logKeg->id_logke) }}"
                                                                        method="post">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <div class="dropdown" style="margin-bottom: 15px;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="exportDropdown">
                                        <a class="dropdown-item"
                                            href="{{ route('kuliah.export.excelKegiatanPICMingguan') }}">Excel
                                            Mingguan</a>
                                        <a class="dropdown-item"
                                            href="{{ route('kuliah.export.excelKegiatanPICBulanan') }}">Excel
                                            Bulanan</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="table-1"
                                                    ...
                                                    style="width: 182.087px;">No HP
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="table-1"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Email: activate to sort column ascending"
                                                    style="width: 182.087px;">Email
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="table-1"
                                                    rowspan="1" colspan="1"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="table-1"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Total Hari: activate to sort column ascending"
                                                    style="width: 182.087px;">
                                                    Total Hari</th>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewModalLabelPIC{{ $logKeg->id_logke }}">View
                                        Details</h5>
                ...
                @foreach ($data as $logKeg)
                    ...
                    <div class="modal fade" id="viewModal{{ $logKeg->id_logke }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewModalLabel{{ $logKeg->id_logke }}">View Details
                                    </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
